...
$title = get_field( 'title' ) ?: __( 'Featured products', 'sariyah' );
$description = get_field( 'description' );
$count = max( 1, min( 24, (int) ( get_field( 'count' ) ?: 8 ) ) );
$columns = max( 2, min( 6, (int) ( get_field( 'columns' ) ?: 4 ) ) );
$products = wc_get_products( array( 'limit' => $count, 'status' => 'publish', 'featured' => true, 'orderby' => 'date', 'order' => 'DESC' ) );
?>
<section class="sariyah-products sariyah-products--featured"><div class="sariyah-container">
