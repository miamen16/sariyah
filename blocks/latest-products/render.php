<?php
/** Dynamic WooCommerce latest products. */
if ( ! function_exists( 'wc_get_products' ) ) {
    return;
}

$title       = get_field( 'title' ) ?: __( 'Latest products', 'sariyah' );
...
?>
<section class="sariyah-products sariyah-products--latest">
    <div class="sariyah-container">
        ...
        <?php else : ?>
            <p class="sariyah-products__empty"><?php esc_html_e( 'No products found.', 'sariyah' ); ?></p>
        <?php endif; ?>
    </div>
</section>
